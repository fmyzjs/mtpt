...
(
	...
	'text_free' => "免费授权",
	'text_nexus' => "关于",
	'text_nexus_note' => "是竹轩基于nexusphp修改而来。<br /><br />",
	'text_authorization' => "关于授权",
	'text_authorization_note' => PROJECTNAME."为开源项目，可自由获取。",
	...
	'text_stylesheet_note' => PROJECTNAME."的页面布局完全基于CSS设计，这使得用户自定义网站外观和添加新的界面风格都变得简单。以下为本站拥有的界面风格列表。如果你想要帮助我们设计，请<a href=\"#contact\" class=\"faqlink\">联系我们</a>。",
	'text_name' => "名称",
	'text_designer' => "作者",
	'text_comment' => "说明",
	'text_contact' => "联系",
